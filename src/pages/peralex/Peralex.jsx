...
const Peralex = () => {
    <UseAOSInit />
    return (
           <div data-aos="fade-up" className="my-28 ">
            <Title title='about our bussness' subTitle='about us'></Title>
             <div data-aos="fade-up" className="card-background md:flex items-center">
                ...
                <div data-aos="fade-left" className="md:w-[90%] mr-6 ">
                    ...
                    <button className="btn btn-primary">contact us<FaPhoneAlt /> </button>
                </div>
            </div>
           </div>
    );
